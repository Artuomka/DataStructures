...
public class RecurList1Tests {
	LListRecur1 lst = new LListRecur1();
	...
	{	
		...
		Assert.assertEquals(expected, actual);
		int [] expected_ar =  {10, 34, 5, 78, 94, 36, 42};
	...
	{	
		...
		Assert.assertEquals(expected, actual);
		int [] expected_ar =  {1, 10, 5, 78, 94, 36, 42};
		int [] actual_ar = lst.toArray();
		Assert.assertArrayEquals(expected_ar, actual_ar);
	}
